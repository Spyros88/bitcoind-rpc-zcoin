...
function RpcClient(opts) {
  ...
  this.user = opts.user || 'YANNISCOOLUSER';
  this.pass = opts.pass || 'YANNPASSISCOOL';
...
RpcClient.callspec = {
  ...
  sendMany: 'str obj int str',  //works
  ...
  //New Sigma calls
  spendmany: 'str obj int str', //sigma spend
  mint: 'string',
  listsigmamints: '',
  listsigmapubcoins: '',
  listsigmaspends: 'int bool',
